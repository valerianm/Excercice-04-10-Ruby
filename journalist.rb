...
puts " handlebars dans notre array."

#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

def count_number
  c=0
  @journalists.each do |cn|
    sc=cn.chars
    sc.each do |cc|
...
def count_aude
  c=0
  @journalists.each do |ca|
    if ca.index (/aude/i)
      c=c+1
    end
  end
  print c
  puts " contiennent aude."
end
...
def count_first_M
  ...
  @journalists.each do |cn|
    sc=cn.chars
    if sc[1].capitalize==sc[1] && sc[1] != "_"
      c=c+1
    end
  end
  print c
  puts " commence par une majuscule."
end
...
def count_M
  ...
  @journalists.each do |cn|
    sc=cn.chars
    sc.each do |cc|
      if cc == "0" || cc == "1" ||cc == "2" ||cc == "3" ||cc == "4" ||cc == "5" ||cc == "6" ||cc == "7" ||cc == "8" ||cc == "9" ||cc == "@" ||cc == "_"
      elsif cc==cc.capitalize
        c=c+1
        break
      end
    end
  ...
  print c
  puts " contiennent une masjuscule."
end
...
def ordre_alphabetique
  print @journalists.sort_by { |x| x.downcase }
  puts
end
